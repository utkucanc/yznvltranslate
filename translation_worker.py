...
class TranslationWorker(QObject):
    ...
    def __init__(self, input_folder, output_folder, api_key, startpromt, model_version="gemini-2.5-flash-preview-09-2025"):
        super().__init__()
        self.input_folder = input_folder
        self.output_folder = output_folder
        self.api_key = api_key
        self.prompt_prefix = startpromt
        self.model_version = model_version # Model versiyonu
    ...
    def run(self):
        ...
        try:
            ...
            for i, file_name in enumerate(files_to_translate):
                # Duraklatma Döngüsü: Duraklatılmışsa ve hala çalışıyorsa bekle
                ...
                while retry_count < MAX_RETRIES:
                    # İç döngüde de duraklatma ve durdurma kontrolü
                    while self.is_paused and self.is_running:
                        time.sleep(0.5)
                    ...
                    try:
                        ...
                        if ("500" in last_error or "429" in last_error) and retry_count < MAX_RETRIES - 1:
                            ...
                            # Bekleme sırasında durdurmayı kontrol et
