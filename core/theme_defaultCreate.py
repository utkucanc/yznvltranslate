...
#topbar   { background-color: #0b0f19; border-bottom: 1px solid #1f2937; }
#connbar  { background-color: #111827; border-bottom: 1px solid #1f2937; }
#sidebar  { background-color: #0b0f19; border-right: 1px solid #1f2937; }
#statusbar { background-color: #111827; border-top: 1px solid #1f2937; }
...
#innerCard { background-color: #0f1522; }
#cardTitle { color: #e5e7eb; font-size: 14px; font-weight: 700; }
...
#navBtn {
    ...
    color: #9ca3af; border-radius: 8px; font-size: 13px; padding: 8px 10px;
}
#navBtn:hover { background-color: #0f1522; color: #e5e7eb; }
#navBtnActive {
    text-align: left; background-color: rgba(59, 130, 246, 0.15);
    border: 1px solid rgba(59, 130, 246, 0.35);
    color: #3b82f6;
    border-radius: 8px; font-size: 13px; font-weight: 600; padding: 8px 10px;
}

#ghostBtn { background: transparent; border: none; color: #9ca3af; font-size: 12px; }
#ghostBtn:hover { color: #e5e7eb; }
#winBtn { background: transparent; border: none; color: #9ca3af; }
#winBtn:hover { background-color: #0f1522; }
#iconBtn {
    background-color: #0f1522; border: 1px solid #1f2937;
...
#primaryBtn:hover, #newProjectBtn:hover { background-color: #2563eb; }

#purpleBtn {
    background-color: #6A1B9A; border: none; color: #ffffff;
    border-radius: 6px; font-size: 11px; padding: 5px 10px;
}
#greenBtn {
    background-color: #22c55e; border: none; color: #ffffff;
    border-radius: 6px; font-weight: 700; padding: 9px;
}
#dangerBtn {
    background-color: #ef4444; border: none; color: #ffffff;
    border-radius: 6px; font-size: 11px; padding: 5px 10px;
}
#orangeBtn {
    background-color: #f59e0b; border: none; color: #ffffff;
    border-radius: 6px; font-size: 11px; padding: 5px 10px;
}
#linkBtn { background: transparent; border: none; color: #3b82f6; font-size: 11px; }
#pageBtn {
    background-color: #0f1522; border: 1px solid #1f2937;
...
QCheckBox#toggleSwitch::indicator {
    ...
    background-color: #1f2937; border: 1px solid #1f2937;
}
